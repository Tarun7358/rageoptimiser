      ...
      <div className="page-header">
        <div className="page-title-row" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <button 
              className={`btn ${voiceModule?.status === 'enabled' ? 'btn-secondary' : 'btn-primary'}`}
            ...
            >
              <span style={{
                ...
                height: '8px',
                borderRadius: '50%',
                backgroundColor: voiceModule?.status === 'enabled' ? 'var(--color-success)' : 'rgba(255,255,255,0.4)',
                display: 'inline-block'
              }} />
              {voiceModule?.status === 'enabled' ? 'Module Enabled' : 'Module Disabled'}
            </button>
